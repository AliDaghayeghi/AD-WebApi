...
using ADWebApi.Models.Services;
...
namespace ADWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connection = "Data Source=DESKTOP-0NJDLGV; Initial Catalog=WebApi; Integrated Security=True; MultipleActiveResultSets=true";
